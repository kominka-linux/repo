...
#define SYS_ICH_VMCR_EL2_Op1                            4
#define SYS_ICH_VMCR_EL2_CRn                            12
#define SYS_ICH_VMCR_EL2_CRm                            11
#define SYS_ICH_VMCR_EL2_Op2                            7

#define FEAT_GCIE_ICH_VMCR_EL2_VPMR                     GENMASK(31, 27)
#define FEAT_GCIE_ICH_VMCR_EL2_VPMR_MASK                GENMASK(31, 27)
#define FEAT_GCIE_ICH_VMCR_EL2_VPMR_SHIFT               27
#define FEAT_GCIE_ICH_VMCR_EL2_VPMR_WIDTH               5

#define FEAT_GCIE_ICH_VMCR_EL2_EN                       GENMASK(0, 0)
#define FEAT_GCIE_ICH_VMCR_EL2_EN_MASK                  GENMASK(0, 0)
#define FEAT_GCIE_ICH_VMCR_EL2_EN_SHIFT                 0
#define FEAT_GCIE_ICH_VMCR_EL2_EN_WIDTH                 1

#define FEAT_GCIE_ICH_VMCR_EL2_RES0                     (UL(0) | GENMASK_ULL(63, 32) | GENMASK_ULL(26, 1))
#define FEAT_GCIE_ICH_VMCR_EL2_RES1                     (UL(0))
#define FEAT_GCIE_ICH_VMCR_EL2_UNKN                     (UL(0))

#define ICH_VMCR_EL2_VPMR                               GENMASK(31, 24)
#define ICH_VMCR_EL2_VPMR_MASK                          GENMASK(31, 24)
#define ICH_VMCR_EL2_VPMR_SHIFT                         24
#define ICH_VMCR_EL2_VPMR_WIDTH                         8

#define ICH_VMCR_EL2_VBPR0                              GENMASK(23, 21)
#define ICH_VMCR_EL2_VBPR0_MASK                         GENMASK(23, 21)
#define ICH_VMCR_EL2_VBPR0_SHIFT                        21
#define ICH_VMCR_EL2_VBPR0_WIDTH                        3

#define ICH_VMCR_EL2_VBPR1                              GENMASK(20, 18)
#define ICH_VMCR_EL2_VBPR1_MASK                         GENMASK(20, 18)
#define ICH_VMCR_EL2_VBPR1_SHIFT                        18
#define ICH_VMCR_EL2_VBPR1_WIDTH                        3

#define ICH_VMCR_EL2_VEOIM                              GENMASK(9, 9)
#define ICH_VMCR_EL2_VEOIM_MASK                         GENMASK(9, 9)
#define ICH_VMCR_EL2_VEOIM_SHIFT                        9
#define ICH_VMCR_EL2_VEOIM_WIDTH                        1

#define ICH_VMCR_EL2_VCBPR                              GENMASK(4, 4)
#define ICH_VMCR_EL2_VCBPR_MASK                         GENMASK(4, 4)
#define ICH_VMCR_EL2_VCBPR_SHIFT                        4
#define ICH_VMCR_EL2_VCBPR_WIDTH                        1

#define ICH_VMCR_EL2_VFIQEn                             GENMASK(3, 3)
#define ICH_VMCR_EL2_VFIQEn_MASK                        GENMASK(3, 3)
#define ICH_VMCR_EL2_VFIQEn_SHIFT                       3
#define ICH_VMCR_EL2_VFIQEn_WIDTH                       1

#define ICH_VMCR_EL2_VAckCtl                            GENMASK(2, 2)
#define ICH_VMCR_EL2_VAckCtl_MASK                       GENMASK(2, 2)
#define ICH_VMCR_EL2_VAckCtl_SHIFT                      2
#define ICH_VMCR_EL2_VAckCtl_WIDTH                      1

#define ICH_VMCR_EL2_VENG1                              GENMASK(1, 1)
#define ICH_VMCR_EL2_VENG1_MASK                         GENMASK(1, 1)
#define ICH_VMCR_EL2_VENG1_SHIFT                        1
#define ICH_VMCR_EL2_VENG1_WIDTH                        1

#define ICH_VMCR_EL2_VENG0                              GENMASK(0, 0)
#define ICH_VMCR_EL2_VENG0_MASK                         GENMASK(0, 0)
#define ICH_VMCR_EL2_VENG0_SHIFT                        0
#define ICH_VMCR_EL2_VENG0_WIDTH                        1
